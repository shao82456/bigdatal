...
##### 2.2 offset-manager 配置

###### 2.2.1 redis-cluster
```

spark.source.kafka.offset.store.type=redis-cluster
spark.source.kafka.offset.store.redis.hosts=192.168.12.29
spark.source.kafka.offset.store.redis.port=7001
spark.source.kafka.offset.store.redis.auth=LxygwQf
...
spark.source.kafka.offset.store.class=com.homework.da.kafka.manager.CodisBnsOffsetsManager
#codis bns name
spark.source.offset.store.codis.bns=codis-ykbzrdd.na.bjdd
