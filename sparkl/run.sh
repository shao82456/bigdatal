...
function main(){
	...
	local submit_wait="--conf spark.yarn.submit.waitAppCompletion=false"
	local main_parameter="--name $appname --properties-file $proper --files $base/log4j.properties $jars --class $main $main_jar"
